# FakeFullbright
Why install a fullbright mod or download a resource pack when you can support it natively on your server?

---

## Features
- Instantly toggle on and off using the `/fb` command
- Works across all minecraft versions 1.8 and up
- Avoid hassle installing a mod or a texture pack
